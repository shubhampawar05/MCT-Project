        ...
        <div className="">
            ...
            <div className="input flex justify-center ">
                <input
                    ...
                    className=' bg-gray-200 placeholder-gray-400 rounded-lg px-2 py-2 w-72 lg:w-72 md:w-72 outline-none text-black '
                />
            </div>

            {/* search drop-down  */}
            <div className=" flex justify-center">
                {search && <div className="block absolute bg-gray-200 w-72 md:w-76 lg:w-72 z-50 my-1 rounded-lg px-2 py-2">
