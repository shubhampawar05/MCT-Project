...
const BuyNowModal = ({ addressInfo, setAddressInfo, buyNowFunction }) => {
    ...
    return (
        <>
            ...
            <Dialog open={open} handler={handleOpen} className=" shadow-lg">
                <DialogBody className="">
                    ...
                    <div className="">
                        <Button
                            ...
                            className="w-full px-4 py-3 text-center text-gray-100 bg-red-400 hover:bg-red-600 border border-transparent dark:border-gray-700 rounded-lg"
                        >
                            Buy now
                        </Button>
                    </div>
